...
import toml, time, datetime, pathlib
import time
...
author = BLOG_AUTHOR = metadata['author']  # (translatable)
project = BLOG_TITLE = metadata['module']  # (translatable)

# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = metadata['home-page']
html_base_url = BASE_URL = SITE_URL = metadata['home-page']
...
copyright = RSS_COPYRIGHT_PLAIN = 'Contents © {date} {author} {license}'
