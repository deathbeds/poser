...
def call(object, *args, **kwargs): return (object if callable(object)
                                           else null)(*args, **kwargs)
...
def complex_operation(self, callable, *args, partial=partial_object, **kwargs):
    return self.append(partial(callable, *args, **kwargs)
                       if args or kwargs else callable)
